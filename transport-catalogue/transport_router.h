...
public:
    explicit TransportRouter(const RoutingSettings& settings, const TransportCatalogue& db);
...
private:
    ...
    void BuildGraph();
    void AddStopsToGraph(size_t& vertex_id);  // ADDITIONAL DECLARATION
    void AddBusesToGraph(double velocity_factor); // ADDITIONAL DECLARATION
};
